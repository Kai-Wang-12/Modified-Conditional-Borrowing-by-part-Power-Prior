...
//  Uniform distribution as the initial prior of the random discounting parameters
...
model {
  ...
  // MCBpP2 constructed using each external control arm and the Jeffreys' prior
